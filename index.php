...
<!-- End banner Area -->
>>>>>>> fc15cfb67391d52c6537144847373a854e0849e1
		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-70 col-lg-8">
				<div class="title text-center">
					...
					<p>Crafting memories, one shot at a time.</p>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-3 col-md-6 single-blog">
				...
				<p class="meta">19 October, 2023 | <a href="#">Navratri</a></p>
				...
				<a href="#" class="details-btn d-flex justify-content-center align-items-center"><span
						class="details">show more</span><span class="lnr lnr-arrow-right"></span></a>
			</div>
			<div class="col-lg-3 col-md-6 single-blog">
				<div class="thumb">
...
<!-- start gallery area -->
<!-- <div class="heading-A">
	<h1>VSOM Glimpsesh </h1>
	<p>A Tour of Our Gallery</p>
</div> -->
<section class="sec">

	<div class="title text-center">
		<h1 class="mb-10">Gallery of Memories </h1>
		<p class="mb-10">Crafting memories, one shot at a time.</p>
	</div>
	<div class="gallerystart ">

		<div class="items">
			<div class="item">
				<a href=""><img src="./img/navratri 1.jpg" alt=""></a>
				<div class="more">
					<h4> <a href="">Images to Remember</a></h4>
					<button class="bttn">show more</button>
				</div>
			</div>
			<div class="item">
				<a href=""><img src="./img/convocation.jpg" alt=""></a>
				<div class="more">
					<h4><a href="">Moments in Time</a></h4>
					<button class="bttn">show more</button>
				</div>
			</div>
			<div class="item">
				<a href=""><img src="./img/maheshwar.jpg" alt=""></a>
				<div class="more">
					<h4><a href="">Journey in Images</a></h4>
					<button class="bttn">show more</button>
				</div>
			</div>
		</div>
